...
const HeroSection = ({ children }) => (
    <div className="relative bg-gradient-to-bl bg-neutral-950 via-transparent from-blue-950 dark:via-transparent0">
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-44 mx-auto">
            <div className="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
                <div>
                    <p className="inline-block text-sm font-medium bg-clip-text bg-gradient-to-l from-blue-600 to-violet-500 text-transparent">
                        A true vision for 2025
                    </p>
                    <div className="mt-4 md:mb-12 max-w-2xl">
                        <h1 className="mb-4 font-semibold text-gray-200 text-4xl lg:text-5xl">
                    ...
                    <blockquote className="hidden md:block relative max-w-sm">
                        <svg className="absolute top-0 start-0 transform -translate-x-6 -translate-y-8 size-16 text-gray-700" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <footer className="mt-3">
                            <div className="flex items-center gap-x-4">
                                ...
                                <div className="grow">
                                    <div className="font-semibold text-gray-500">Josh Grazioso</div>
